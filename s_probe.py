...
class sProbe(object):
    ...
    def refresh():
        while(sProbe.going):
            ...
            #print(sProbe.chargerate or sProbe.dischargerate)
    ...
    @staticmethod
    def get_chem():
        ogchem = sProbe.msbatt['BatteryStaticData']['Chemistry']
        if ogchem is not None:
            sProbe.chem_str = sProbe.getchemstr(ogchem)
